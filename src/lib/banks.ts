...
export const banks: Bank[] = [
  ...
  },
  {
    ...
    endpointFormat: "https://receipt.ebirr.com/{tenant}/{token}",
    responseType: "html",
    description:
    ...
    referenceFormat: "Receipt URL (receipt.ebirr.com/{tenant}/{token}) or tenant/token string (e.g., nib/abc123, wegagen/xyz, ahadu/def, kaafimf/ghi)",
    referenceExample: "nib/abc123def",
    howToVerify: [
      "Get the receipt URL or tenant/token from the eBirr app receipt sharing feature",
      "Paste the full URL (https://receipt.ebirr.com/nib/abc123) or just the tenant/token (nib/abc123) into cheki",
      "cheki fetches the receipt from receipt.ebirr.com and parses the HTML for transaction details",
      "The partner bank is auto-detected from the tenant code in the URL",
    ],
    useCases: [
    ...
    faq: [
      {
        q: "Which banks does eBirr cover?",
        a: "eBirr connects 5 financial institutions: Nib International Bank (tenant: nib), Wegagen Bank (tenant: wegagen), Ahadu Bank (tenant: ahadu), KAAKI Microfinance (tenant: kaafimf), and Cooperative Bank of Oromia / Siinqee Bank. All use the same receipt endpoint at receipt.ebirr.com/{tenant}/{token}.",
      },
      {
        q: "How do I find my eBirr receipt URL?",
        a: "Open the eBirr app, go to your transaction history, tap the transaction, and use the share button. The shared link will be in the format receipt.ebirr.com/{tenant}/{token}. You can paste this full URL or just the tenant/token part into cheki.",
      },
      {
        q: "Is eBirr different from Telebirr?",
        a: "Yes. Telebirr is Ethio Telecom's mobile wallet. eBirr is a separate mobile money platform operated by eBirr Inc. that partners with multiple banks. They are completely different services with different receipt endpoints.",
      },
      {
        q: "Is the eBirr receipt endpoint public?",
        a: "Yes. The receipt URL at receipt.ebirr.com/{tenant}/{token} is publicly accessible without authentication. The token is a random string that maps to a specific transaction. cheki, qbirr, and any other verification service use this same endpoint.",
      },
    ],
    seo: {
      title: "Verify eBirr Receipts Online | Nib, Wegagen, Ahadu, KAAFI",
      description:
        "Verify eBirr mobile money receipts for free. Covers Nib International Bank, Wegagen Bank, Ahadu Bank, and KAAFI Microfinance. No signup, no API key.",
      keywords: [
        "eBirr receipt verification",
        "verify eBirr transaction",
        "Nib International Bank receipt",
        "Wegagen Bank receipt verify",
        "Ahadu Bank receipt",
        "KAAFI microfinance receipt",
        "ebirr.com receipt check",
      ],
    },
  },
  {
    ...
    status: "soon",
    color: "#1d4ed8",
    endpoint: "receipt.ebirr.com/nib",
    endpointFormat: "https://receipt.ebirr.com/nib/{token}",
    responseType: "html",
    description:
      "Nib International Bank is one of Ethiopia's largest private banks with 410 branches. Nib partners with eBirr for mobile money services. Receipts are available via receipt.ebirr.com/nib/{token}. Verification is handled through cheki's eBirr parser.",
    referenceFormat: "eBirr receipt URL or tenant/token (nib/{token})",
    referenceExample: "nib/abc123def",
    howToVerify: [
      "Use the eBirr receipt sharing feature in the Nib mobile app",
      "Paste the receipt URL or tenant/token into cheki",
      "cheki detects the 'nib' tenant and fetches from receipt.ebirr.com",
    ],
    useCases: ["Merchants verifying Nib Bank transfers", "Businesses reconciling Nib deposits"],
    faq: [
      { q: "How do I verify a Nib International Bank receipt?", a: "Nib Bank uses the eBirr platform for mobile receipts. Share the receipt from the Nib app to get a receipt.ebirr.com/nib/{token} URL, then paste it into cheki. Select 'eBirr' from the bank dropdown." },
    ],
    seo: {
      title: "Verify Nib International Bank Receipts Online",
      description: "Verify Nib International Bank receipts for free via eBirr. No signup, no API key.",
      keywords: ["Nib International Bank receipt", "verify Nib Bank", "Nib Bank eBirr"],
    },
  },
  {
    code: "wegagen",
    ...
    status: "soon",
    color: "#b45309",
    endpoint: "receipt.ebirr.com/wegagen",
    endpointFormat: "https://receipt.ebirr.com/wegagen/{token}",
    responseType: "html",
    description:
    ...
    referenceFormat: "eBirr receipt URL or tenant/token (wegagen/{token})",
    referenceExample: "wegagen/abc123def",
    howToVerify: [
      "Use the eBirr receipt sharing feature in the Wegagen mobile app",
      "Paste the receipt URL or tenant/token into cheki",
    ],
    useCases: ["Merchants verifying Wegagen Bank transfers", "Businesses reconciling Wegagen deposits"],
    faq: [
      { q: "How do I verify a Wegagen Bank receipt?", a: "Wegagen Bank uses the eBirr platform. Share the receipt to get a receipt.ebirr.com/wegagen/{token} URL, then paste it into cheki." },
    ],
    seo: {
      title: "Verify Wegagen Bank Receipts Online",
      description: "Verify Wegagen Bank receipts for free via eBirr. No signup, no API key.",
      keywords: ["Wegagen Bank receipt", "verify Wegagen", "Wegagen eBirr"],
    },
  },
  {
    code: "ahadu",
    ...
    status: "soon",
    color: "#7c3aed",
    endpoint: "receipt.ebirr.com/ahadu",
    endpointFormat: "https://receipt.ebirr.com/ahadu/{token}",
    responseType: "html",
    description:
    ...
    referenceFormat: "eBirr receipt URL or tenant/token (ahadu/{token})",
    referenceExample: "ahadu/abc123def",
    howToVerify: [
      "Use the eBirr receipt sharing feature in the Ahadu mobile app",
      "Paste the receipt URL or tenant/token into cheki",
    ],
    useCases: ["Merchants verifying Ahadu Bank transfers", "Businesses reconciling Ahadu deposits"],
    faq: [
      { q: "How do I verify an Ahadu Bank receipt?", a: "Ahadu Bank uses the eBirr platform. Share the receipt to get a receipt.ebirr.com/ahadu/{token} URL, then paste it into cheki." },
    ],
    seo: {
      title: "Verify Ahadu Bank Receipts Online",
      description: "Verify Ahadu Bank receipts for free via eBirr. No signup, no API key.",
      keywords: ["Ahadu Bank receipt", "verify Ahadu", "Ahadu eBirr"],
    },
  },
  {
    code: "kaafi",
    name: "KAAFI Microfinance",
    shortName: "KAAFI",
    type: "mobile",
    requiresAccount: false,
    status: "soon",
    color: "#0891b2",
    endpoint: "receipt.ebirr.com/kaafimf",
    endpointFormat: "https://receipt.ebirr.com/kaafimf/{token}",
    responseType: "html",
    description:
    ...
    referenceFormat: "eBirr receipt URL or tenant/token (kaafimf/{token})",
    referenceExample: "kaafimf/abc123def",
    howToVerify: [
      "Use the eBirr receipt sharing feature in the KAAFI app",
      "Paste the receipt URL or tenant/token into cheki",
    ],
    useCases: ["Merchants verifying KAAFI payments", "Businesses reconciling KAAFI transfers"],
    faq: [
      { q: "How do I verify a KAAFI Microfinance receipt?", a: "KAAFI uses the eBirr platform with tenant code 'kaafimf'. Share the receipt to get a receipt.ebirr.com/kaafimf/{token} URL, then paste it into cheki." },
    ],
    seo: {
      title: "Verify KAAFI Microfinance Receipts Online",
      description: "Verify KAAFI Microfinance receipts for free via eBirr. No signup, no API key.",
      keywords: ["KAAFI receipt", "verify KAAFI", "Kaafi Ebirr", "KAAFI microfinance receipt"],
    },
  },
  {
    code: "abay",
    ...
    color: "#4338ca",
    endpoint: "Unknown",
    endpointFormat: "Researching public receipt endpoint",
    responseType: "json",
    description:
    ...
    faq: [
      { q: "Can I verify Abay Bank receipts with cheki?", a: "Not yet. We are researching Abay Bank's receipt system. If you have an Abay Bank receipt with a QR code or receipt URL, contact us so we can investigate the endpoint." },
    ],
    seo: {
      title: "Verify Abay Bank Receipts Online",
      description: "Abay Bank receipt verification is coming to cheki. Free, no signup.",
      keywords: ["Abay Bank receipt", "verify Abay Bank", "Abay Bank transaction"],
    },
  },
  {
    code: "addis",
    ...
    faq: [
      { q: "Can I verify Addis International Bank receipts with cheki?", a: "Not yet. We are researching Addis Bank's receipt system." },
    ],
    seo: {
      title: "Verify Addis International Bank Receipts Online",
      description: "Addis International Bank receipt verification is coming to cheki.",
      keywords: ["Addis International Bank receipt", "verify Addis Bank"],
    },
  },
  {
    code: "amhara",
    ...
    faq: [
      { q: "Can I verify Amhara Bank receipts with cheki?", a: "Not yet. We are researching Amhara Bank's receipt system." },
    ],
    seo: {
      title: "Verify Amhara Bank Receipts Online",
      description: "Amhara Bank receipt verification is coming to cheki.",
      keywords: ["Amhara Bank receipt", "verify Amhara Bank"],
    },
  },
  {
    code: "berhan",
    ...
    faq: [
      { q: "Can I verify Berhan International Bank receipts with cheki?", a: "Not yet. We are researching Berhan Bank's receipt system." },
    ],
    seo: {
      title: "Verify Berhan International Bank Receipts Online",
      description: "Berhan International Bank receipt verification is coming to cheki.",
      keywords: ["Berhan International Bank receipt", "verify Berhan Bank"],
    },
  },
  {
    code: "bunna",
    ...
    faq: [
      { q: "Can I verify Bunna International Bank receipts with cheki?", a: "Not yet. We are researching Bunna Bank's receipt system." },
    ],
    seo: {
      title: "Verify Bunna International Bank Receipts Online",
      description: "Bunna International Bank receipt verification is coming to cheki.",
      keywords: ["Bunna International Bank receipt", "verify Bunna Bank"],
    },
  },
  {
    code: "enat",
    ...
    faq: [
      { q: "Can I verify Enat Bank receipts with cheki?", a: "Not yet. We are researching Enat Bank's receipt system." },
    ],
    seo: {
      title: "Verify Enat Bank Receipts Online",
      description: "Enat Bank receipt verification is coming to cheki.",
      keywords: ["Enat Bank receipt", "verify Enat Bank"],
    },
  },
  {
    code: "global",
    ...
    faq: [
      { q: "Can I verify Global Bank Ethiopia receipts with cheki?", a: "Not yet. We are researching Global Bank's receipt system." },
    ],
    seo: {
      title: "Verify Global Bank Ethiopia Receipts Online",
      description: "Global Bank Ethiopia receipt verification is coming to cheki.",
      keywords: ["Global Bank Ethiopia receipt", "verify Global Bank"],
    },
  },
  {
    code: "lion",
    ...
    faq: [
      { q: "Can I verify Lion International Bank receipts with cheki?", a: "Not yet. We are researching Lion Bank's receipt system." },
    ],
    seo: {
      title: "Verify Lion International Bank Receipts Online",
      description: "Lion International Bank receipt verification is coming to cheki.",
      keywords: ["Lion International Bank receipt", "verify Lion Bank", "Anbessa Bank receipt"],
    },
  },
  {
    code: "oromia",
    ...
    faq: [
      { q: "Can I verify Oromia International Bank receipts with cheki?", a: "Not yet. We are researching Oromia Bank's receipt system." },
    ],
    seo: {
      title: "Verify Oromia International Bank Receipts Online",
      description: "Oromia International Bank receipt verification is coming to cheki.",
      keywords: ["Oromia International Bank receipt", "verify Oromia Bank"],
    },
  },
  {
    code: "hibret",
    ...
    faq: [
      { q: "Can I verify Hibret Bank receipts with cheki?", a: "Not yet. We are researching Hibret Bank's receipt system." },
    ],
    seo: {
      title: "Verify Hibret Bank Receipts Online",
      description: "Hibret Bank receipt verification is coming to cheki.",
      keywords: ["Hibret Bank receipt", "verify Hibret Bank", "United Bank Ethiopia receipt"],
    },
  },
  {
    code: "zamzam",
    ...
    faq: [
      { q: "Can I verify ZamZam Bank receipts with cheki?", a: "Not yet. We are researching ZamZam Bank's receipt system." },
    ],
    seo: {
      title: "Verify ZamZam Bank Receipts Online",
      description: "ZamZam Bank receipt verification is coming to cheki.",
      keywords: ["ZamZam Bank receipt", "verify ZamZam Bank", "Islamic bank Ethiopia receipt"],
    },
  },
  {
    code: "hijra",
    ...
    faq: [
      { q: "Can I verify Hijra Bank receipts with cheki?", a: "Not yet. We are researching Hijra Bank's receipt system." },
    ],
    seo: {
      title: "Verify Hijra Bank Receipts Online",
      description: "Hijra Bank receipt verification is coming to cheki.",
      keywords: ["Hijra Bank receipt", "verify Hijra Bank", "Islamic bank Ethiopia receipt"],
    },
  },
  {
    code: "shabelle",
    ...
    faq: [
      { q: "Can I verify Shabelle Bank receipts with cheki?", a: "Not yet. We are researching Shabelle Bank's receipt system." },
    ],
    seo: {
      title: "Verify Shabelle Bank Receipts Online",
      description: "Shabelle Bank receipt verification is coming to cheki.",
      keywords: ["Shabelle Bank receipt", "verify Shabelle Bank"],
    },
  },
  {
    code: "goh",
    ...
    faq: [
      { q: "Can I verify Goh Betoch Bank receipts with cheki?", a: "Not yet. Goh Betoch is a specialized housing bank and may not have standard retail transfer receipts." },
    ],
    seo: {
      title: "Verify Goh Betoch Bank Receipts Online",
      description: "Goh Betoch Bank receipt verification is coming to cheki.",
      keywords: ["Goh Betoch Bank receipt", "verify Goh Betoch"],
    },
  },
  {
    code: "tsedey",
    ...
    faq: [
      { q: "Can I verify Tsedey Bank receipts with cheki?", a: "Not yet. We are researching Tsedey Bank's receipt system." },
    ],
    seo: {
      title: "Verify Tsedey Bank Receipts Online",
      description: "Tsedey Bank receipt verification is coming to cheki.",
      keywords: ["Tsedey Bank receipt", "verify Tsedey Bank"],
    },
  },
  {
    code: "gadaa",
    ...
    faq: [
      { q: "Can I verify Gadaa Bank receipts with cheki?", a: "Not yet. We are researching Gadaa Bank's receipt system." },
    ],
    seo: {
      title: "Verify Gadaa Bank Receipts Online",
      description: "Gadaa Bank receipt verification is coming to cheki.",
      keywords: ["Gadaa Bank receipt", "verify Gadaa Bank"],
    },
  },
  {
    code: "rammis",
    ...
    faq: [
      { q: "Can I verify Rammis Bank receipts with cheki?", a: "Not yet. We are researching Rammis Bank's receipt system." },
    ],
    seo: {
      title: "Verify Rammis Bank Receipts Online",
      description: "Rammis Bank receipt verification is coming to cheki.",
      keywords: ["Rammis Bank receipt", "verify Rammis Bank"],
    },
  },
];
