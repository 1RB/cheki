...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "text", text: "cheki supports 9 banks with 4 live (CBE, Telebirr, BOA, M-Pesa) and 5 in development (Dashen, Awash, Zemen, CBE Birr, Siinqee). It supports both the old and new CBE receipt systems, BOA QR code decryption, and unified QR scanning with multi-scale auto-detection." },
