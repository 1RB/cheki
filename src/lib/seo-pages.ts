...
export const seoPages: SeoPage[] = [
...

  {
    ...
    title: "cheki vs check.et vs verify.et — Which is Best? | cheki",
    h1: "cheki vs check.et vs verify.et",
    metaDescription: "Detailed comparison of Ethiopia's three receipt verification services. Price, features, banks, API, open source. Find out which is best for your business.",
    keywords: ["cheki vs check.et", "check.et alternative", "verify.et alternative", "free receipt verification ethiopia", "best receipt verification service"],
    intent: "commercial",
    faq: [
      { q: "Is cheki really free?", a: "Yes. cheki is 100% free, open source (MIT), and has no limits. check.et charges 499 ETB/month after 200 verifications. verify.et charges $20-40/month." },
      { q: "Do they all use the same data?", a: "Yes. All three services verify receipts by fetching the same public bank endpoints. The data is identical. The difference is pricing, features, and transparency." },
      { q: "Can I self-host check.et or verify.et?", a: "No. check.et and verify.et are closed-source. cheki is open source and includes Docker support for self-hosting on your own infrastructure." },
    ],
    sections: [
      {
        heading: "The core difference",
        body: "All three services do the same thing: they fetch receipts from public bank endpoints and return the data as JSON. The difference is that cheki is free and open source, while check.et and verify.et charge you for the same data.",
      },
      {
        heading: "Feature comparison",
        body: "",
        bullets: [
          "Price: cheki (free) vs check.et (499 ETB/mo) vs verify.et ($20-40/mo)",
          "Free verifications: cheki (unlimited) vs check.et (200 one-time) vs verify.et (200 one-time)",
          "API key: cheki (none) vs check.et (required) vs verify.et (required)",
          "Signup: cheki (none) vs check.et (required) vs verify.et (Telegram OAuth)",
          "Open source: cheki (MIT) vs check.et (no) vs verify.et (no)",
          "Self-hosting: cheki (Docker) vs check.et (no) vs verify.et (no)",
          "Batch verification: cheki (50 at once) vs check.et (no) vs verify.et (no)",
          "Receipt source URL: cheki (shown) vs check.et (hidden) vs verify.et (hidden)",
        ],
      },
    ],
